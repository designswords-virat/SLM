  ...
  <div class="max-w-screen-xl mx-auto px-6 lg:px-10 py-16 lg:py-20">
    <div class="grid lg:grid-cols-2 gap-16 xl:gap-24">
      ...
      <div>
        ...
        <!-- Office location map -->
        <a class="footer-map"
           href="https://www.google.com/maps/search/?api=1&query=B-3%2C+Durga+Path%2C+Ambabari%2C+Jaipur%2C+302039%2C+Rajasthan"
           target="_blank" rel="noopener"
           aria-label="Open SLM Construction office on Google Maps">
          <iframe
            src="https://www.google.com/maps?q=B-3%2C+Durga+Path%2C+Ambabari%2C+Jaipur%2C+302039%2C+Rajasthan&output=embed"
            loading="lazy"
